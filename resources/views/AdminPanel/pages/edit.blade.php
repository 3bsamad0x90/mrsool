    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                {{Form::open(['url'=>route('pages.update',['page'=>$page->id]), 'id'=>'editpageForm', 'class'=>'row
                gy-1 pt-75'])}}
                ...
                <div class="col-12 col-md-12">
                    ...
                    {!!Form::textarea('content_ar',$page->content_ar,['id'=>'content_ar', 'class'=>'form-control
                    editor_ar'])!!}
                </div>
                <div class="col-12 col-md-12">
                    <label class="form-label" for="content_en">{{trans('common.content_en')}}</label>
                    {!!Form::textarea('content_en',$page->content_en,['id'=>'content_en', 'class'=>'form-control
                    editor_en'])!!}
                </div>
